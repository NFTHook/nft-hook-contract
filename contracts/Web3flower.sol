...
contract Drex is ERC721A, Ownable {

    uint256 public constant FREE_SUPPLY = 5;
    uint256 public constant PAID_SUPPLY = 10;

    uint256 private _flag;
    string private _defTokenURI = "https://ipfs.io/ipfs/QmcZBh2aQ6p4D3PxnpAtzF6tAKv6S9RrEBrKscLp4JYjTy";
    ...
    constructor() Ownable(msg.sender) ERC721A("DREX", "DEX") {
    }
    ...
    function mint(uint256 quantity) public payable {
        ...
        if (quantity < FREE_SUPPLY ) {
            require(msg.value >= 0.00005888 ether, "ERC721: Insufficient payment");
            ...
            require(msg.value >= 0.0001888 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        }
