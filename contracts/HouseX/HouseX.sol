...
contract HouseX is ERC721A, ERC2981, Ownable, DefaultOperatorFilterer {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmdQYzYozC8Vo4rqKyRQP3bFh43za8VBg2y5zk1yedcFrp";
    ...
    constructor() Ownable(msg.sender) ERC721A("HouseX", "HX") {
