...
contract Allure is ERC721A, Ownable {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmePenJprw8Pkw3C1cYswkdsjnkMemHyCDR88qKCjgYLcB";
    ...
    constructor() Ownable(msg.sender) ERC721A("A Great Day", "AGD") {
    }
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity == FREE_SUPPLY || quantity == PAID_SUPPLY || quantity == 100, "ERC721: Invalid quantity");
