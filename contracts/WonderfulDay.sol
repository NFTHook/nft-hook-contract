...
contract WonderfulDay is ERC721A, Ownable {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmZiw2xXtxbGgp67RXF9QfJro4Rbc5qQzAWzfu6hz9xbDQ";
    ...
    function mint(uint256 quantity) public payable {
        ...
        if (quantity == 1 ) {
            ...
            require(msg.value >= 0.000288 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        }
