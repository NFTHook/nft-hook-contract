...
contract ForgWorld is ERC721A, Ownable {

    uint256 private _flag = 1;
    string private _defTokenURI = "https://ipfs.io/ipfs/QmcZBh2aQ6p4D3PxnpAtzF6tAKv6S9RrEBrKscLp4JYjTy";
    string private _baseTokenURI = "https://ipfs.io/ipfs/Qmcqmw3bdnoE6dwsipSVA9kJTUvuZkp2EV5LaE8oK2CT4a/json/";
    ...
    constructor() Ownable(msg.sender) ERC721A("ForgWorld", "FWD") {
    }
