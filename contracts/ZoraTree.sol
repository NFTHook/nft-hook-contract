...
contract ZoraTree is ERC721A, Ownable {

    uint256 public constant FREE_SUPPLY = 3;
    uint256 public constant PAID_SUPPLY = 10;

    uint256 private _flag;
    string private _defTokenURI = "https://ipfs.io/ipfs/QmWxmvi812UmBGEdADdtBenR53CA7Un5LB6W3vfvN1xdCp";
    ...
    constructor() Ownable(msg.sender) ERC721A("Zora Tree", "ZTE") {
    }
