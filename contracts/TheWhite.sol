...
contract TheWhite is ERC721A, Ownable {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmTbkpeGpLkdSn6kqpJWCY7ue8CviH3VQvvkMwKMrcXVHV";
    ...
    function mint(uint256 quantity) public payable {
        ...
        if (quantity == 1 ) {
            require(msg.value >= 0.000005 ether, "ERC721: Insufficient payment");
