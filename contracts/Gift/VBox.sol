...
contract VGiftBox is ERC721A, ERC2981, Ownable, DefaultOperatorFilterer {
    ...
    string private _baseTokenURI = "https://ipfs.io/ipfs/bafybeigrcws7nosbos3cbxn5pbuc525gprkwf3a4gzsiuxlsegswofrp4m/box/";
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(!_hasMinted[msg.sender], "ERC721: Already minted");
