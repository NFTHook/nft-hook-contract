...
contract InnocentLollipop is ERC721A, ERC2981, Ownable, DefaultOperatorFilterer {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmZmLH4YHmWu5Ly1vd8jtQCXfWHGaTbzNqfwkugrE4q7F3";
    ...
    constructor() Ownable(msg.sender) ERC721A("Innocent lollipop", "ILP") {
