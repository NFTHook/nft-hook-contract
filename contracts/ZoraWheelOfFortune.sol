...
contract ZoraWheelOfFortune is ERC721A, Ownable {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmYiQTshanv64CdsEuoApfMRvDkrhuxQSDn5eDMaPyXmoB";
    ...
    function mint(uint256 quantity) public payable {
        ...
        if (quantity < FREE_SUPPLY ) {
            require(msg.value >= 0.000188 ether, "ERC721: Insufficient payment");
            ...
            require(msg.value >= 0.002488 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        } else if (quantity == 400 ) {
            require(msg.value >= 0.003288 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        } else if (quantity == 500 ) {
            require(msg.value >= 0.004088 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        } else {
