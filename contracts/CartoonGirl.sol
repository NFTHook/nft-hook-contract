...
contract CartoonGirl is ERC721A, Ownable {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmRs214ofZzJxYsZqCtFk5msWDoXrDuQPtD96w9uCQxw2m";
    ...
    constructor() Ownable(msg.sender) ERC721A("Cartoon Girl", "CGL") {
    }
