...
contract ZoraOGPass is ERC721A, Ownable {
    ...
    string private _defTokenURI = "https://ipfs.io/ipfs/QmShKswpiPBxnAQycwRHNNSerQr5xs5hVFh7YC8KX89oQk";
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity == FREE_SUPPLY || quantity == PAID_SUPPLY || quantity == 100 || quantity == 200 || quantity == 1000 , "ERC721: Invalid quantity");
        ...
        if (quantity < FREE_SUPPLY ) {
            ...
            require(msg.value >= 0.0008 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        } else if (quantity == 200 ) {
            require(msg.value >= 0.0016 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        } else if (quantity == 1000 ) {
            require(msg.value >= 0.007 ether, "ERC721: Insufficient payment");
            _safeMint(msg.sender,quantity);
        } else {
